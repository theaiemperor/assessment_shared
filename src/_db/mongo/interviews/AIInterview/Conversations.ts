...
export const AIInterviewQuestionZ = z.object({
...
export type IAIInterviewQuestionZ = z.infer<typeof AIInterviewQuestionZ>;



export const AIInterviewAnswerZ = z.object({
    order: z.number().min(1),
...
export type IAIInterviewAnswerZ = z.infer<typeof AIInterviewAnswerZ>;



export const AIInterviewConversationZ = z.object({
    ...
    screeningQuestions: z.array(AIInterviewQuestionZ),

    screeningAnswers: z.array(AIInterviewAnswerZ),
    ...
    questions: z.record(
        ...
        z.array(AIInterviewQuestionZ).describe('A list of all the questions into this round')
    ),
